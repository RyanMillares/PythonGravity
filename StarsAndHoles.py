...
def main():
    ...
    prev_y = -1
    prev_x = -1
    win = GraphWin('StarsAndHoles', x_dims, y_dims) #4/13
    ...
    center_gravity2 = -(center_radius**2)
    circle2 = Circle(Point(2 * x_dims/4, y_dims/2), center_radius)
    ...
    center_gravity3 = (center_radius**3)
    ...
    while(True):
        ...
        for circle, choose_color, num, mass in circles:
            ...
            for pull_star in pull_stars:
                ...
                if star_dist < pull_star.getRadius():
